...
def write_clusters(create_clusters_with_weights, csv_file_name):
    """It extracts clusters and singletons, writes them to separate files"""
    thresholds = [100.0, 99.8, 99.5, 99.0, 98.0, ]
...
if __name__ == "__main__":
    ...
    write_clusters(create_clusters_with_weights, csv_file_name)
